 ...
 * @nullable
 */
export type GameListVictory = Victory | null;
...
export interface GameList {
  ...
  /** @nullable */
  readonly victory: GameListVictory;
 ...
 * @nullable
 */
export type GameRetrieveVictory = Victory | null;
...
export interface GameRetrieve {
  ...
  readonly sandbox: boolean;
  /** @nullable */
  readonly victory: GameRetrieveVictory;
  readonly variantId: string;
  readonly nationAssignment: string;
 ...
 * @nullable
 */
export type OrderStep = (typeof OrderStep)[keyof typeof OrderStep] | null;
 ...
 * @nullable
 */
export type OrderResolutionBy = Province | null;

export interface OrderResolution {
  status: string;
  /** @nullable */
  by: OrderResolutionBy;
}
...
export const OrderStep = { ...StepEnum, ...NullEnum } as const;
 ...
 * @nullable
 */
export type UnitDislodgedBy = { [key: string]: unknown } | null;
...
export const useDevicesCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getDevicesCreateMutationOptions(options);

  return useMutation(mutationOptions, queryClient);
};

export const devicesUpdate = (fCMDevice: NonReadonly<FCMDevice>) => {
  return customInstance<FCMDevice>({
    url: `/devices/`,
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
export const useDevicesUpdate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getDevicesUpdateMutationOptions(options);

  return useMutation(mutationOptions, queryClient);
};

export const gameCreate = (gameCreate: GameCreate, signal?: AbortSignal) => {
...
export type GameCreateMutationResult = NonNullable<
  Awaited<ReturnType<typeof gameCreate>>
>;
export type GameCreateMutationBody = GameCreate;
...
export const useGameCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameCreateMutationOptions(options);
...
export const useGameConfirmPhaseUpdate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameConfirmPhaseUpdateMutationOptions(options);
...
export const useGameJoinCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameJoinCreateMutationOptions(options);
...
method that returns the game object. Also adds game to the serializer context.
 */
export const gameLeaveDestroy = (gameId: string) => {
  return customInstance<void>({
...
export const useGameLeaveDestroy = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameLeaveDestroyMutationOptions(options);
...
export const useGameOrdersCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameOrdersCreateMutationOptions(options);
...
export const getGameOrdersListQueryKey = (
  gameId?: string,
  phaseId?: number
) => {
...
method that returns the current phase for the game. Also adds phase to the serializer context.
 */
export const gameOrdersDeleteDestroy = (gameId: string, sourceId: string) => {
  return customInstance<void>({
...
>(
  ...
  TContext
> => {
  const mutationOptions = getGameOrdersDeleteDestroyMutationOptions(options);
...
export const useGameResolvePhaseCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getGameResolvePhaseCreateMutationOptions(options);
...
>(
  ...
  TContext
> => {
  const mutationOptions = getGamesChannelsCreateCreateMutationOptions(options);
...
export const usePhaseResolveCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getPhaseResolveCreateMutationOptions(options);
...
export type SandboxGameCreateMutationResult = NonNullable<
  Awaited<ReturnType<typeof sandboxGameCreate>>
>;
export type SandboxGameCreateMutationBody = GameCreateSandbox;
...
export const useSandboxGameCreate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getSandboxGameCreateMutationOptions(options);
...
export const userUpdateUpdate = (userProfile: NonReadonly<UserProfile>) => {
...
export const useUserUpdateUpdate = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  const mutationOptions = getUserUpdateUpdateMutationOptions(options);
...
>(
  ...
  TContext
> => {
  const mutationOptions = getUserUpdatePartialUpdateMutationOptions(options);
...
export const getGamePhaseRetrieveResponseMock = (
  ...
  scheduledResolution: `${faker.date.past().toISOString().split(".")[0]}Z`,
