...
const NationAssignmentScreen: React.FC = () => {
...
const NationAssignmentScreenSuspense: React.FC = () => (
  <Suspense fallback={<div></div>}>
    <NationAssignmentScreen />
  </Suspense>
);

export { NationAssignmentScreenSuspense as NationAssignmentScreen };
