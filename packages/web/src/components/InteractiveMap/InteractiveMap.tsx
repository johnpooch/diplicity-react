  ...
  return (
    ...
    >
            ...
            return (
              <g key={province.id}>
                <path
                  ...
                  onMouseLeave={() =>
                    props.interactive && setHoveredProvince(null)
                  }
                  onClick={event =>
                    props.interactive &&
                    props.onClickProvince?.(province.id, event)
                  }
                >
          ...
          {[...props.phase.units]
            ...
            .map((unit, index) => {
              const province = map.provinces.find(
                p => p.id === unit.province.id
              );
              ...
              const hasDisbandOrder = props.orders?.some(
                o =>
                  o.orderType === "Disband" && o.source.id === unit.province.id
              );
