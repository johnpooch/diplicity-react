...
export const mockGames: GameList[] = [
  ...
  },
  {
    ...
    phases: [1],
    currentPhaseId: 1,
    currentPhase: { id: 1, ordinal: 1, season: "Spring", year: 1901, name: "Spring 1901, Movement", type: "movement", status: "pending", scheduledResolution: null, remainingTime: 0, units: [], supplyCenters: [] },
    phaseConfirmed: false,
    private: false,
    anonymous: false,
