...
const primaryClassName =
  "flex min-h-11 min-w-0 flex-1 items-center gap-3 px-3 py-list-row-py text-left outline-none focus-visible:z-10 focus-visible:ring-[3px] focus-visible:ring-ring/50";
...
function ListItem({
  ...
  return (
    ...
    >
      {primary}
      {trailingAction != null && (
        <div className="flex shrink-0 items-center py-list-row-py pr-1.5">
          {trailingAction}
        </div>
      )}
    </li>
