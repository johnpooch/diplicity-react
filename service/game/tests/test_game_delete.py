...
class TestGameDeleteView:
    ...
    def test_delete_sandbox_game_as_creator(self, authenticated_client, sandbox_game_with_gm):
        game = sandbox_game_with_gm()
    ...
    def test_delete_sandbox_game_cascades_related_data(
        self, authenticated_client, sandbox_game_with_gm
    ):
        game = sandbox_game_with_gm()
    ...
    def test_delete_sandbox_game_as_non_creator(
        self, authenticated_client_for_secondary_user, sandbox_game_with_gm
    ):
        game = sandbox_game_with_gm()
        url = reverse(delete_viewname, args=[game.id])
    ...
    def test_delete_sandbox_game_unauthenticated(
        self, unauthenticated_client, sandbox_game_with_gm
    ):
        game = sandbox_game_with_gm()
        url = reverse(delete_viewname, args=[game.id])
